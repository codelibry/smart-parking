...
get_template_part('blocks/content-list-dup', null, [
  ...
  'description' => get_field('primary-content-list_content-list__description'),
  'subtitle' => get_field('primary-content-list_content-list__subtitle'),
  'list' => get_field('primary-content-list_content-list__list'),
  'moretext' => get_field('primary-content-list_content-list__moretext'),
  'button_1' => get_field('primary-content-list_content-list__button-1'),
  'button_2' => get_field('primary-content-list_content-list__button-2'),
  'additional_classes' => get_field('primary-content-list_content-list__additional-classes'),
  'is_content_left' => get_field('primary-content-list_content-list__is-content-left'),
]);
